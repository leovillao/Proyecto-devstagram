...
Route::get('/register', [RegisterController::class, 'index'])->name('register'); // se carga la vista del formulario de registro
Route::post('/register', [RegisterController::class, 'store']); // se envia el formulario de registro
// rutas para la visualizacion de login y para logear al usuario
